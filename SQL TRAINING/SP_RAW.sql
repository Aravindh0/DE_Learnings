...
-- INSERTING THE ABOVE DATA IN A SEPERATE TEMP TABLE
...
-- CONVERTING FROM SCIENTIFIC VALUES (NOTE - SOME DATAS ARE VARCHAR SO WE ARE CHANGING IT TO NUMERIC)
...
CROSS JOIN [dbo].[rwindref]

--SELECT * FROM #CROSSJOIN 
--JOINING BOTN CROSSJOIN AND #TEMP

SELECT C.TimeSeries,
	C.flidarid,T.windkey,T.packavalavg1, T.wdirtnavg1, T.wdirtnstd1, T.hwsavg1, T.hwsmin1, T.hwsmax1, T.hwsstd1, T.vwsavg1, T.ti1, T.intflag1, T.extflag1, T.enabled1,
...
LEFT JOIN
	#TEMP AS T
ON 
	T.flidarid = C.flidarid 
AND
	T.datetimekey = C.TimeSeries

-- INSERTING THE JOINED DATA IN NEW TABLE

SELECT * INTO #FINAL_TBL
FROM
(SELECT 
	ROW_NUMBER()over(ORDER BY C.flidarid) + 7124 AS sno,T.windkey AS twindkey,C.TimeSeries AS datetimekey,
	T.windkey,C.flidarid,T.packavalavg1, T.wdirtnavg1, T.wdirtnstd1, T.hwsavg1, T.hwsmin1, T.hwsmax1, T.hwsstd1, T.vwsavg1, T.ti1, T.intflag1, T.extflag1, T.enabled1,
    T.packavalavg2, T.wdirtnavg2, T.wdirtnstd2, T.hwsavg2, T.hwsmin2, T.hwsmax2, T.hwsstd2, T.vwsavg2, T.ti2, T.intflag2, T.extflag2, T.enabled2,
    T.packavalavg3, T.wdirtnavg3, T.wdirtnstd3, T.hwsavg3, T.hwsmin3, T.hwsmax3, T.hwsstd3, T.vwsavg3, T.ti3, T.intflag3, T.extflag3, T.enabled3,
    T.packavalavg4, T.wdirtnavg4, T.wdirtnstd4, T.hwsavg4, T.hwsmin4, T.hwsmax4, T.hwsstd4, T.vwsavg4, T.ti4, T.intflag4, T.extflag4, T.enabled4,
    T.packavalavg5, T.wdirtnavg5, T.wdirtnstd5, T.hwsavg5, T.hwsmin5, T.hwsmax5, T.hwsstd5, T.vwsavg5, T.ti5, T.intflag5, T.extflag5, T.enabled5,
...
ON 
	T.flidarid = C.flidarid 
AND
	T.datetimekey = C.TimeSeries) AS A
...
EXEC RENEW_SP
-- SELECT MAX(sno) FROM [dbo].[twind] --506909
